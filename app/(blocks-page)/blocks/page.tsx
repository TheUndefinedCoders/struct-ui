...
import blocksOverviewCards from '@/configs/blocksOverview';
    ...
    <>
      <div className='pt-20 pb-5'>
        ...
        <p className='md:text-lg text-sm text-muted-foreground lg:w-[80%]'>
          Beautifully designed Blocks/Sections that you can copy and paste into your apps. Accessible. Customizable. Open Source.
        </p>

        <div className='grid md:grid-cols-3 grid-cols-2 gap-6 py-4'>
          {blocksOverviewCards?.map((component, index) => {
            return (
              <>
                <Link
                  href={component?.url}
